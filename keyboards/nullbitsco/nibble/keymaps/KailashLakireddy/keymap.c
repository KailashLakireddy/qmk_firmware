...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MA] = LAYOUT_ansi(
        ...
        KC_MNXT, KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP,
        KC_MPRV, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_UP,   KC_PGDN,
        KC_MPLY, KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                    KC_RALT, MO(_FN), KC_RCTL, KC_LEFT,          KC_DOWN, KC_RGHT
    ),
    [_FN] = LAYOUT_ansi(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
          RESET, _______, _______, _______,                   _______,                   _______, _______, _______, KC_MPRV,          KC_MPLY, KC_MNXT
    ),
};
...
*/
// Underglow LED stuff
// docs: https://docs.qmk.fm/#/feature_rgblight

// caps lock indicator color defined here
const rgblight_segment_t PROGMEM my_capslock_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 10, HSV_MAGENTA}     // all leds magenta
);

// function indicator color defined here
const rgblight_segment_t PROGMEM my_function_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 10, HSV_ORANGE}      // all leds orange
);
...
// create rgblight list with different color definitions
...
void keyboard_post_init_user(void) {
    ...
    rgblight_mode(RGBLIGHT_MODE_BREATHING);  //THIS LINE IS DOING NOTHING
    rgblight_sethsv(HSV_OFF);
}


// If the caps led is on then enable caps colors
bool led_update_user(led_t led_state) {
    rgblight_set_layer_state(1, led_state.caps_lock);
    return true;
}

//  Default layer. May not be necessary 
layer_state_t default_layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(0, layer_state_cmp(state, _MA));
    return state;
}


//  If function layer is on then enable func colors
